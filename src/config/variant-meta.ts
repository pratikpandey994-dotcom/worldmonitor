...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'TradeTerminal - Personalized Trading Workspace',
    description: 'Personalized B2B trading workspace with forex and metals watchlists, market heatmaps, and AI-analyzed macro headlines.',
    keywords: 'trading terminal, forex watchlist, metals trading, gold trading, macro headlines, market heatmap, B2B trading workspace, FX desk, trading dashboard, central banks, macroeconomics',
    url: 'https://www.worldmonitor.app/',
    siteName: 'TradeTerminal',
    shortName: 'TradeTerminal',
    subject: 'Personalized Trading Workspace and Market Intelligence',
    classification: 'Trading Terminal, Market Intelligence Workspace',
    ...
    features: [
      ...
      'Market heatmaps',
      'AI-analyzed macro headlines',
      'Watchlist-scoped impact feed',
