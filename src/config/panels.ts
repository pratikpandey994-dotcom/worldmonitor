...
// ============================================
// FULL VARIANT (Forex/Gold Terminal)
// ============================================
const FULL_PANELS: Record<string, PanelConfig> = {
  markets: { name: 'Forex & Gold Watchlist', enabled: true, priority: 1 },
  finance: { name: 'Global Macro News', enabled: true, priority: 1 },
  ...
  'world-clock': { name: 'Market Sessions', enabled: true, priority: 2 },
};
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  core: {
    ...
    panelKeys: ['markets', 'finance', 'forex', 'centralbanks', 'economic', 'gold-silver', 'gold-intelligence', 'economic-calendar', 'macro-signals', 'fear-greed', 'world-clock'],
  },
